...
#define SET_RS  LCD_RSPORT->BSRR |= LCD_RS				// stan wysoki na linii RS
#define CLR_RS 	LCD_RSPORT->BRR |= LCD_RS		// stan niski na linii RS

#define SET_RW 	LCD_RWPORT->BSRR |= LCD_RW			// stan wysoki na RW - odczyt z LCD
#define CLR_RW 	LCD_RWPORT->BRR |= LCD_RW		// stan niski na RW - zapis do LCD

#define SET_E 	LCD_EPORT->BSRR |= LCD_E			// stan wysoki na linii E
#define CLR_E 	LCD_EPORT->BRR |= LCD_E			// stan niski na linii E
